...
- [x] **Phase 13: v2.0 QA & GO/NO-GO** — Production build gate, Lighthouse re-baseline (desktop + mobile PSI), mobile visual QA, dark-mode FOUC, secret scan, GO verdict (completed 2026-05-21)
...
- [x] 08-07-PLAN.md — Verify MOTION-08 preservation: `git diff main` byte-equality for Lenis/template/ScrollReveal + Vitest preservation tests + `vercel build --prod` phase gate + human smoke test (automated portion complete; D-11 build gate + manual smoke deferred to 08-HUMAN-UAT.md)
...
- [x] 13-02-PLAN.md — Lighthouse desktop median-of-3 on 5 routes (QA-V2-02)
- [x] 13-03-PLAN.md — PSI mobile homepage gate (QA-V2-03)
- [x] 13-04-PLAN.md — 375px visual QA on /, /writing, /events, /photos (QA-V2-04)
- [x] 13-05-PLAN.md — D-14 secret scan + dark-mode light-only decision (QA-V2-05, QA-V2-06)
- [x] 13-06-PLAN.md — compile GO/NO-GO doc, human sign-off, /gsd:complete-milestone v2.0 (QA-V2-07)
